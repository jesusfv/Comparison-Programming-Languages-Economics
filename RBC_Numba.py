...
def main_func():
    ...
    print(f"Output =  {outputSteadyState}, Capital = {capitalSteadyState}, Consumption =  {consumptionSteadyState}")
    ...
    while(maxDifference > tolerance):
        ...
        if(iteration%10 == 0 or iteration == 1):
            print(f" Iteration = {iteration}, Sup Diff = {maxDifference}")
...
if __name__ == '__main__':
    ...
    t2 = time.time()
    print("")
    print(f"Final Iteration = {iterate}, Sup Duff = {maxDiff}")
    print("")
    print(f"My Check = {mPolicyFunction[1000-1,3-1]}")
    print("")
